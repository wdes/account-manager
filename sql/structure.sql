...
CREATE TABLE `usernames` (
  `id` int(10) unsigned NOT NULL COMMENT 'Username id',
  `idUser` int(10) unsigned NOT NULL COMMENT 'User id',
  `username` varchar(255) NOT NULL COMMENT 'Username',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idUser` (`idUser`,`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Usernames';
